...
CFLAGS = -fno-pic -static -fno-builtin -fno-strict-aliasing -fvar-tracking -fvar-tracking-assignments -O0 -ggdb3 -Wall -MD -gdwarf-2 -m32 -Werror -fno-omit-frame-pointer
...
ULIB = ulib.o usys.o printf.o umalloc.o bitmap.o themis_ui.o
...
#QEMUEXTRA = -device usb-ehci,id=usb,bus=pci.0,addr=0x4 -device usb-tablet
